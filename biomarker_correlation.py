...
save_dir = f"figures/correlation/correlation_change{week}wk_"
if(primary_only): save_dir += "primary.png"
else: save_dir += "both.png"
...
fig.ax_heatmap.set_xticklabels(fig.ax_heatmap.get_xmajorticklabels(), fontsize = 6)     # decrease font size
